import{r as x,u as He,a as Ve,j as o,z as ze,y as le}from"./index-K-g7UO0K.js";const We=()=>{};var de={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dt(t){return t.endsWith(".cloudworkstations.dev")}async function ut(t){return(await fetch(t,{credentials:"include"})).ok}class ${constructor(e,r,n){this.name=e,this.instanceFactory=r,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const D=new vt("@firebase/app"),Bt="@firebase/app-compat",Pt="@firebase/analytics-compat",jt="@firebase/analytics",Mt="@firebase/app-check-compat",$t="@firebase/app-check",Lt="@firebase/auth",Ut="@firebase/auth-compat",Ft="@firebase/database",Ht="@firebase/data-connect",Vt="@firebase/database-compat",zt="@firebase/functions",Wt="@firebase/functions-compat",Gt="@firebase/installations",Kt="@firebase/installations-compat",qt="@firebase/messaging",Jt="@firebase/messaging-compat",Yt="@firebase/performance",Xt="@firebase/performance-compat",Zt="@firebase/remote-config",Qt="@firebase/remote-config-compat",er="@firebase/storage",tr="@firebase/storage-compat",rr="@firebase/firestore",nr="@firebase/vertexai",sr="@firebase/firestore-compat",ar="firebase",ir="11.7.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ae="[DEFAULT]",or={[se]:"fire-core",[Bt]:"fire-core-compat",[jt]:"fire-analytics",[Pt]:"fire-analytics-compat",[$t]:"fire-app-check",[Mt]:"fire-app-check-compat",[Lt]:"fire-auth",[Ut]:"fire-auth-compat",[Ft]:"fire-rtdb",[Ht]:"fire-data-connect",[Vt]:"fire-rtdb-compat",[zt]:"fire-fn",[Wt]:"fire-fn-compat",[Gt]:"fire-iid",[Kt]:"fire-iid-compat",[qt]:"fire-fcm",[Jt]:"fire-fcm-compat",[Yt]:"fire-perf",[Xt]:"fire-perf-compat",[Zt]:"fire-rc",[Qt]:"fire-rc-compat",[er]:"fire-gcs",[tr]:"fire-gcs-compat",[rr]:"fire-fst",[sr]:"fire-fst-compat",[nr]:"fire-vertex","fire-js":"fire-js",[ar]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(e,r,n){this._isDeleted=!1,this._options=Object.assign({},e),this._config=Object.assign({},r),this._name=r.name,this._automaticDataCollectionEnabled=r.automaticDataCollectionEnabled,this._container=n,this.container.addComponent(new $("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(e){this.checkDestroyed(),this._automaticDataCollectionEnabled=e}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(e){this._isDeleted=e}checkDestroyed(){if(this.isDeleted)throw C.create("app-deleted",{appName:this._name})}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gr="firebase-heartbeat-database",mr=1,L="firebase-heartbeat-store";let Q=null;function Oe(){return Q||(Q=Ct(gr,mr,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(L)}catch(r){console.warn(r)}}}}).catch(t=>{throw C.create("idb-open",{originalErrorMessage:t.message})})),Q}async function br(t){try{const r=(await Oe()).transaction(L),n=await r.objectStore(L).get(Be(t));return await r.done,n}catch(e){if(e instanceof B)D.warn(e.message);else{const r=C.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});D.warn(r.message)}}}async function be(t,e){try{const n=(await Oe()).transaction(L,"readwrite");await n.objectStore(L).put(e,Be(t)),await n.done}catch(r){if(r instanceof B)D.warn(r.message);else{const n=C.create("idb-set",{originalErrorMessage:r==null?void 0:r.message});D.warn(n.message)}}}function Be(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(t){G(new $("platform-logger",e=>new Rt(e),"PRIVATE")),G(new $("heartbeat",e=>new vr(e),"PRIVATE")),O(se,ge,t),O(se,ge,"esm2017"),O("fire-js","")}Ir("");var kr="firebase",Dr="11.7.1";/**
 * @license
